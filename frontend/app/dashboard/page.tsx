      ...
      <DashboardLayout>
        <div className="space-y-8">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1">Loading your dashboard...</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCardSkeleton /><StatCardSkeleton /><StatCardSkeleton /><StatCardSkeleton />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            <div className="h-48 rounded-2xl bg-slate-100 dark:bg-white/[0.04] animate-pulse" />
            <div className="h-48 rounded-2xl bg-slate-100 dark:bg-white/[0.04] animate-pulse" />
            <div className="h-48 rounded-2xl bg-slate-100 dark:bg-white/[0.04] animate-pulse" />
          </div>
        </div>
      ...
      <DashboardLayout>
        <div className="space-y-8">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400 mt-1">Let&apos;s start tracking your career journey.</p>
          </div>
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-5 max-w-sm">Start tracking your job applications to see insights and analytics here.</p>
            <button
          ...
          <div className="grid grid-cols-1 xl:grid-cols-5 gap-4">
            ...
            <div className="xl:col-span-3 p-5 rounded-2xl bg-white dark:bg-white/[0.05] border border-slate-200 dark:border-white/[0.1]">
              ...
              {recentActivity.length === 0 ? (
                <p className="text-sm text-slate-400 dark:text-slate-500 py-8 text-center">No recent activity yet</p>
              ) : (
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    <h3 className="font-semibold text-slate-900 dark:text-white">View Applications</h3>
